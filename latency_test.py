...
from PyQt6.QtWidgets import (QApplication, QMainWindow, QWidget, QVBoxLayout,
                             ...
                             QTextEdit, QLineEdit, QComboBox, QCheckBox) # Keep necessary imports, Added QCheckBox
...
class LatencyTesterApp(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle('jack_delay UI')
...
def main():
    ...
    # QGuiApplication.setDesktopFileName("com.example.latencytester")
